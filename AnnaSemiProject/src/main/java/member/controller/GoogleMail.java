...
public class GoogleMail {
   ...
   public void sendmail_memberOneDetail(String recipient, String name, String emailContent) throws Exception {
       ...
       // 제목 설정
       String subject = "[안나다이아]에서 "+name+"님께 메일보냅니다.";
       msg.setSubject(subject);
       ...
       // 메시지 본문의 내용과 형식, 캐릭터 셋 설정
       msg.setContent("<div style='font-size:14pt; color:black;'>"+emailContent+"</div>", "text/html;charset=UTF-8");
               
       // 메일 발송하기
       Transport.send(msg);
       
	} // end of sendmail_OrderFinish(String email, String name)
}