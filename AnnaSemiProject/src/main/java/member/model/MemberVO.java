...
public class MemberVO {
	...
	private int sms_status;			   // SMS수신동의여부 
	private int email_status;		   // 이메일수신동의여부 
	                                   // 마지막으로 로그인 한 날짜시간이 현재시각으로 부터 1년이 초과(지났으면)하면 휴면으로 지정
	
	/////////////////////////////////////////////////////////////////////
	
	private boolean requirePwdChange = false;
	// 마지막으로 암호를 변경한 날짜가 현재시각으로 부터 3개월이 지났으면 true else false
	...
	public MemberVO(String userid, String pwd, String name, String email, String mobile, String postcode,
			String address, String detailaddress,  String birthday, int sms_status, int email_status) {
		super();
		this.userid = userid;
		this.pwd = pwd;
		this.name = name;
