...
<div class="container">
	...
	<h2 style="margin: 20px auto; font-weight: bold; color: black;">질문수정</h2>	
	
	<form name="qnaInputFrm"
	  action="<%= request.getContextPath()%>/questionEdit.an"
	  method="POST"
			...
			<tbody>
				...
				<tr>
					...
					<td width="500px" align="left" style="border-bottom: hidden;" >
						<input type="text" style="width: 480px;" name="questionTitle" class="box infoData" value="${vo.questionTitle}" >
				...
				<tr>
					...
					<td width="500px" align="left" style="border-bottom: hidden; border-top: hidden;" >
						<input type="text" style="width: 480px; height: 300px;" name="questionContents" class="box infoData" value="${vo.questionContents}"/>
						<span class="error">필수입력</span>
					</td>
				</tr>
				<tr>
