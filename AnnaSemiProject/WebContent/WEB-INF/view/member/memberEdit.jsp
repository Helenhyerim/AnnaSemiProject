...
function goModify() {
		...
		frm.action = "<%= request.getContextPath()%>/member/memberEdit.an";
		frm.method = "post";
		frm.submit();
	}
	   ...
	   <table id="tblMemberRegister">
	      ...
	      <tbody>
	          ...
	          <td style="width: 100%; text-align: left;">
	             <input type="text" name="userid" id="userid" class="requiredInfo" value = "${sessionScope.loginuser.userid}"disabled />
	      ...
	      <tr>
	         ...
	         <td style="width: 100%; text-align: left;">
	             <input type="text" name="name" id="name" class="requiredInfo" value = "${sessionScope.loginuser.name}" disabled /> 
	      ...
	      <tr>
	         ...
	         <td style="text-align: left;">
	            <input type="text" id="birthyyyy" name="birthyyyy" style="width: 60px;" value = "${fn:substring(birthdate,0,4) }" required disabled/>&nbsp;년&nbsp;
	            
	            <input type="text" id="birthmm" name="birthmm" style="margin-left: 2%; height:38px; width: 60px; padding: 8px;" value = "${fn:substring(birthdate,4,6)}"disabled/>
	           
	            &nbsp;월&nbsp;
	            
	            <input type="text" id="birthdd" name="birthdd" style="margin-left: 2%; height:38px; width: 60px; padding: 8px;" value = "${fn:substring(birthdate,6,8) }"disabled/>
